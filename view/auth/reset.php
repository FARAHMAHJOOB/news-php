...
<section class="row mt-5">
    <section class="login-wrapper border-primary-tm bg-light mx-auto col-10 col-md-3 text-right py-5">
        <section class="login-title mx-2">بازیابی رمز عبور</section>
        ...
        <form method="post" action="<?= url('reset-password/' . $forgot_token) ?>">
            ...
            <section class="login-btn d-grid g-2 text-center">
                <button class="btn btn-primary py-2 px-3 w-75">تایید</button>
            </section>
        </form>
        <div class="text-center p-t-136">
            <a class="txt2" href="<?= url('register-form')  ?>">
                ایجاد حساب کاربری
