            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="title" placeholder="عنوان ..." value="<?= old('title' , $post['title'])  ?>" >
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="summary" id="summary" placeholder="خلاصه ..." value="<?=  old('summary' , $post['summary'])  ?>" >
                        <span role="alert" class="text-danger text-sm">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="published_at_view" class="form-control" placeholder="تاریخ انتشار...">
                ...
                <div class="col-md-12 ">
                    <div class="form-group mb-0">
                        ...
                        <textarea class="form-control" name="body" id="body" rows="2" placeholder="توضیحات" ><?=  old('body' , $post['body'])  ?></textarea>
